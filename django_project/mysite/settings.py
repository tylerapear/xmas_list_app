...
#SECRET_KEY = 'django-insecure-3uv+d53-918d4))0+ww+el%%n@)z0=jcggp5^1xxo5b6d@_=^%'
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-3uv+d53-918d4))0+ww+el%%n@)z0=jcggp5^1xxo5b6d@_=^%')
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'mysite.context_processors.pending_invites',
            ],
        },
    },
]
